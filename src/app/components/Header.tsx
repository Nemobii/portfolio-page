                ...
                <nav>
                    <ul className='flex h-full'>
                        ...
                        <li className='relative p-4 self-center group'>
                            ...
                            {/* Dropdown Menü */}
                            <ul className="absolute left-0 mt-2 hidden bg-white shadow-lg rounded-lg opacity-0 group-hover:opacity-100 group-hover:translate-y-2 group-hover:block transition-all duration-300 z-10">
